// E 1 - DEBUT : Découverte Object Date
const Main = document.getElementById("main");
var btn = document.createElement("button");
btn.innerText = "Get Time my Friend";
...
btn.addEventListener("click", function(){
  var d = new Date();
 // E 2 - DEBUT : SET
  d.setMonth(0); // Défini l'Objet de Date
  d.setMonth(getMonth() + 1); // Défini le mois de l'Objet Date comme étant le mois suivant du mois actuel. 
  // E 2 - FIN 
  var divDate = document.createElement("div");
  divDate.className = "date";
  divDate.innerHTML =  "Date : "               + d;
  divDate.innerHTML += "<hr>getDate :"         + d.getDate();
  divDate.innerHTML += "<hr>getDay :"          + d.getDay();
  divDate.innerHTML += "<hr>getMonth :"        + d.getMonth();
  divDate.innerHTML += "<hr>getFullYear :"     + d.getFullYear();
  divDate.innerHTML += "<hr style=\"border: 2px solid red\">";
  divDate.innerHTML += "getHours :"            + d.getHours();
  divDate.innerHTML += "<hr>getMilliseconds :" + d.getMilliseconds();

  divDate.innerHTML += "<hr>Heure complete V1 :" + d.getHours() + ":" + d.getMinutes() + ":" + d.getSeconds() + ":" + d.getMilliseconds();

  // Amélioration si c'est inférieur à 10, ajoute le 0 devant les minutes et les secondes
  divDate.innerHTML += "<hr>Heure complete V2 :" + 
...
/*
    Objectif  :  
       énoncé    :  Découverte de l'Objet DATE
        1.....   
        2.....   
        ----------------------------------------------------------------------------------------
        Evolution : 
